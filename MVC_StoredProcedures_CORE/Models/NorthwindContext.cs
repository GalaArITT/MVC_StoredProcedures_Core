...
namespace MVC_StoredProcedures_CORE.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        //registrar SP
        public DbSet<VentasEmpleado> VentasEmpleado { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.\\SQLDELL;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //agregar el modelo del SP 
            modelBuilder.Entity<VentasEmpleado>(entity =>
            {
                entity.HasNoKey();
                entity.ToView("sp_ventas_empleado");
