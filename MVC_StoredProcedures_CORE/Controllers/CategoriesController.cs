...
using MVC_StoredProcedures_CORE.Models;

namespace MVC_StoredProcedures_CORE.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<ActionResult> MostrarSP()
        {
            List<VentasEmpleado> sp;
            using (var context = new NorthwindContext())
            {
                sp = await context.VentasEmpleado.FromSqlRaw("exec sp_ventas_empleado").ToListAsync();
            }
            return View(sp);
        }
